                  ...
                  >
                    <td className="px-6 py-4 whitespace-nowrap">
                      <Link href={`/projects/${project.id}`} className="flex items-center gap-3 group/link">
                        <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-green-power-500 to-green-power-600 flex items-center justify-center flex-shrink-0 shadow-sm group-hover/link:shadow-md transition-shadow">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      {project.customerEmail && (
                        <div className="text-xs text-gray-500 mt-0.5 truncate max-w-[200px]">{project.customerEmail}</div>
                      )}
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-right">
                      ...
                      >
                        ...
                        <Link
                          ...
                          className="w-9 h-9 rounded-lg bg-gray-100 hover:bg-gray-200 flex items-center justify-center text-gray-600 hover:text-gray-700 transition-colors group/icon"
                          title="Edit"
                        >
                          <svg className="w-5 h-5 group-hover/icon:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <button
                          ...
                          className="w-9 h-9 rounded-lg bg-red-50 hover:bg-red-100 flex items-center justify-center text-red-600 hover:text-red-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors group/icon"
                          title="Delete"
                        >
                          {deleting === project.id ? (
