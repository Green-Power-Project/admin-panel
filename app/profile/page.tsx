            ...
            <div className="flex items-center gap-6">
              <div className="w-20 h-20 bg-white rounded-2xl flex items-center justify-center shadow-xl">
                <span className="text-3xl font-bold text-green-power-700">
                  {name ? name.charAt(0).toUpperCase() : currentUser?.email?.charAt(0).toUpperCase() || 'A'}
                </span>
              </div>
              <div className="flex-1">
                ...
                <p className="text-green-power-200 text-xs mt-1">Administrator Account</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden sticky top-6">
              ...
              <div className="p-6 space-y-6">
                <div className="pb-6 border-b border-gray-200">
                  ...
                  <p className="text-sm text-gray-900 break-all bg-gray-50 px-3 py-2 rounded-lg border border-gray-200">
                    {currentUser?.email}
                  </p>
