...
// Supports both nested keys (e.g. folders.02_Photos.description as obj.folders["02_Photos"]["description"])
// and flat keys with dots (e.g. folders["02_Photos.description"])
...
export function LanguageProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    async function loadLanguagePreference() {
      // First check localStorage for immediate load; otherwise keep default (de)
      if (typeof window !== 'undefined') {
        const savedLang = localStorage.getItem('admin-language') as Language;
        if (savedLang === 'en' || savedLang === 'de') {
