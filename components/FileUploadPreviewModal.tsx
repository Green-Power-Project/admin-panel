      ...
      <div className="flex min-h-full items-center justify-center p-4">
        ...
        >
          ...
          <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
            <button
              type="button"
              className="inline-flex w-full justify-center rounded-md bg-green-power-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-power-700 focus:ring-green-power-500 sm:ml-3 sm:w-auto"
              onClick={onConfirm}
            >
              Upload File
            </button>
