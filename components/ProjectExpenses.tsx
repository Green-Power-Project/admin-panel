        ...
        >
          ...
          >
            ...
            <div className="px-6 py-5 space-y-4">
              ...
              {/* Paid / Unpaid */}
              <div>
                <label className="block text-xs font-semibold text-gray-700 mb-1.5">{t('expenses.form.paidLabel')}</label>
                <div className="flex gap-2">
                  <button
                    type="button"
                    onClick={() => setForm((f) => ({ ...f, isPaid: true }))}
                    className={`flex-1 py-2 rounded-lg text-xs font-semibold border-2 transition-all ${
                      form.isPaid ? 'bg-green-100 text-green-700 border-green-400' : 'bg-white text-gray-600 border-gray-200 hover:border-gray-300'
                    }`}
                  >
                  ...
                  <button
                    ...
                    className={`flex-1 py-2 rounded-lg text-xs font-semibold border-2 transition-all ${
                      !form.isPaid ? 'bg-red-100 text-red-700 border-red-400' : 'bg-white text-gray-600 border-gray-200 hover:border-gray-300'
                    }`}
                  >
                    ⏳ {t('expenses.form.unpaid')}
                  </button>
                </div>
              </div>
            </div>
